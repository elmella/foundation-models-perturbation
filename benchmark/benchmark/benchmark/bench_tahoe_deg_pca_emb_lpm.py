"""
Benchmark script for tahoe DEG on LPM-restricted compounds.
...
Usage:
    ...
    python benchmark/benchmark/bench_tahoe_deg_pca_emb_lpm.py --config-name config_tahoe_deg_pca_emb_lpm_dose3 --multirun hydra/launcher=joblib hydra.launcher.n_jobs=4

    # Dose 10 (CVCL_0023)
    python benchmark/benchmark/bench_tahoe_deg_pca_emb_lpm.py --config-name config_tahoe_deg_pca_emb_lpm_dose10 --multirun hydra/launcher=joblib hydra.launcher.n_jobs=4
"""
...
def get_submission_dir(dose):
    ...
    return SUBMISSION_DIR / f"expression/pert_prediction_tahoe_deg_pca_emb_lpm_dose_{dose_str}"
...
@hydra.main(version_base=None, config_path="config/tahoe", config_name="config_tahoe_deg_pca_emb_lpm_dose3")
